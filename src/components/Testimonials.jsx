...
const testimonials = [
  { name: 'Dr. Sarah Quantum', text: 'The flavor complexity in each sip is mind-bending. It\'s not just coffee, it\'s an exploration of taste.', image: '/images/sarah-quantum.avif' },
  { name: 'Captain John Nebula', text: 'As someone who\'s traveled the stars, I can say this coffee truly takes you on a journey.', image: '/images/john-nebula.avif' },
